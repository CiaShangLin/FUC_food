...
class RoboTest {
    ...
    fun DetailShopActivity_Test() {
        ...
        mainActivity.startActivity(Intent(mainActivity, DetailShopActivity::class.java).apply {
        ...
        var shadowActivity=ShadowActivity()
        var toolbar=shadowActivity.contentView.findViewById<Toolbar>(R.id.detailShopTb)
        System.out.println(toolbar.title)
        System.out.println(shadowActivity.resultIntent.extras.getString(DataConstant.SHOP_TYPE_TAG))
